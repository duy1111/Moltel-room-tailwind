...
const SelectInput = ({label,options,value,setValue,type,reset}) => {
  ...
  return (
    ...
    <div className='flex flex-col gap-2 py-4 w-1/4' >
        ...
        <select id='select-address ' onChange={(e) => setValue(e.target.value)} value={reset ?'': value} className='outline-none border border-gray-300 w-full py-1' >
